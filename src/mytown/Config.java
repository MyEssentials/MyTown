...
public class Config extends Configuration {
    ...
    private void loadGeneralConfigs() throws IOException {
        ...
        prop = get("general", "opsCanBypass", false);
        prop.comment = "Whether OPs can bypass perms";
        Resident.opBypasses = prop.getBoolean(Resident.opBypasses);
    ...
    private void loadDatabaseConfigs() {
        ...
        prop.comment = "Table name prefix to use. <pre>towns etc..";
