...
public class PortalGun extends ProtBase {
    ...
    Class<?> clPortalBall, clEntityBlock;
    ...
    public void load() throws Exception {
        ...
        clEntityBlock = Class.forName("portalgun.common.entity.EntityBlock");
    }
    ...
    public boolean isEntityInstance(Entity e) {
        return clPortalBall.isInstance(e) || clEntityBlock.isInstance(e);
    }

    @Override
    public String update(Entity e) throws Exception {
    	if (clPortalBall.isInstance(e)){
	        ...
	        if (owner != null && !systemOwnerNames.contains(owner)) {
	            ...
	            for (int i = 0; i < 7; i++) {
	                if (!r.canInteract(collision.blockX + xPos[i], collision.blockY + yPos[i], collision.blockZ + zPos[i], "build")) {
    	...
    	} else if (clEntityBlock.isInstance(e)){
