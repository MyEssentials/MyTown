...
public class NoAccessException extends Exception {
    ...
    /*
     * private String getCustomizedMessage(String def) { String message; String
     * perm = node; int index;
     * 
     * while ((index = perm.lastIndexOf(".")) != -1) { perm = perm.substring(0,
     * index);
     * 
     * message = ForgePerms.getPermissionsHandler().getOption(executor,
     * "permission-denied-" + perm, null); // TODO
     * Permissions.getOption(executor, "permission-denied-" + perm, // null); if
     * (message == null) { continue; }
     * 
     * return message; }
     * 
     * // TODO message = Permissions.getOption(executor, "permission-denied", //
     * null); message = ForgePerms.getPermissionsHandler().getOption(executor,
