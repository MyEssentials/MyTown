	...
	public void processCommand(ICommandSender cs, String[] var2) 
	{
        ...
        if (cs instanceof EntityPlayerMP){
    		...
    		try
    		{
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.reload")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.reschannels")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.wipedim")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.new")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.delete")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.set")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.rem")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.extra")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.snoop")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.extrares")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			else if (var2[0].equalsIgnoreCase(Term.TownadmCmdPerm.toString()))
    			{
    				...
    				{
    					if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.perm.show." + node)) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    				...
    				else
    				{
    					...
    					{
    						if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.perm.set." + node + "." + var2[3])) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    					...
    					{
    						if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.perm.force." + node)) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
    			...
    			{
    				if (!MyTown.instance.perms.canAccess(p.username, p.worldObj.provider.getDimensionName(), "mytown.adm.cmd.claim")) { cs.sendChatToPlayer(Term.ErrCannotAccessCommand.toString()); return; }
