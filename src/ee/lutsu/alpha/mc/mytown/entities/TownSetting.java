...
public class TownSetting {
    ...
    public TownSetting(String name, String key, Object value, Object wildValue,
            String valueDesc, Class instanceOf) {
        this.name = name;
        seriaKey = key;
        this.value = value;
    ...
    public String getVisualValue() {
        return (effectiveValue == null ? "null" : effectiveValue.toString())
                + (value == null && effectiveValue != null ? " (inherited)"
                        : "");
    }

    public void setValue(String from) {
        if (from == null || from.equalsIgnoreCase("inherit")
            ...
            value = new Boolean(from.equalsIgnoreCase("1")
                    || from.equalsIgnoreCase("on")
                    || from.equalsIgnoreCase("active")
                    || from.equalsIgnoreCase("yes")
