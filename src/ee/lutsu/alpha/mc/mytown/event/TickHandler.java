...
import ee.lutsu.alpha.mc.mytown.event.tick.OldResidentRemover;
import ee.lutsu.alpha.mc.mytown.event.tick.OldTownRemover;
...
public class TickHandler implements ITickHandler {
    ...
    public String getLabel() {
        return "MyTown general work tick handler.";
    }
}
