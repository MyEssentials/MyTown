...
import ee.lutsu.alpha.mc.mytown.event.prot.RangedTools;
...
public class ProtectionEvents implements ITickHandler{
    ...
    public ProtectionEvents(){
        ProtectionEvents.entityProtections.addAll(
            Arrays.asList(
                new ProtBase[]{
                    Creeper.instance,
                    Mobs.instance,
        ...
        ProtectionEvents.tileProtections.addAll(
            Arrays.asList(
                new ProtBase[]{
                        BuildCraft.instance,
                        RedPower.instance,
        ...
        ProtectionEvents.toolProtections.addAll(
            Arrays.asList(
                new ProtBase[]{
                    BuildCraft.instance,
                    RedPower.instance,
