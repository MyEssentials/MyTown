...
public class ProjectileProtection extends ProtBase {
	...
	public String update(Entity e) throws Exception {
		...
		// if
		// (ProtectionEvents.instance.getNPCClasses().contains(thrower.getClass()))
		// return null; // Ignore NPC's
		// if (thrower == null || !(thrower instanceof EntityPlayer))
		// return "Thrower is null or not a player";
		// Resident res = ProtectionEvents.instance.lastOwner =
		// Resident.getOrMake((EntityPlayer) thrower);
		// if (res == null)
