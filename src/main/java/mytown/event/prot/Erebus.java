...
public class Erebus extends ProtBase {
	...
	public String update(Entity e) throws Exception {
		...
		if (!thrower.canInteract(dim, x - radius, y, z - radius, Permissions.Build) || !thrower.canInteract(dim, x - radius, y, z + radius, Permissions.Build) || !thrower.canInteract(dim, x + radius, y, z - radius, Permissions.Build)
				|| !thrower.canInteract(dim, x + radius, y, z + radius, Permissions.Build)) {
