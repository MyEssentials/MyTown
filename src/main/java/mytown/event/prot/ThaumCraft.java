...
public class ThaumCraft extends ProtBase {
	...
	public String update(Entity e) throws Exception {
		...
		int dim = e.dimension;
		if (!thrower.canInteract(dim, x - radius, y - radius, y + radius, z - radius, Permissions.Build) || !thrower.canInteract(dim, x - radius, y - radius, y + radius, z + radius, Permissions.Build) || !thrower.canInteract(dim, x + radius, y - radius, y + radius, z - radius, Permissions.Build)
