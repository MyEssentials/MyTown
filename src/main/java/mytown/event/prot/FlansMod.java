	...
	public String update(Entity e) throws Exception {
		if (clEntityBullet.isInstance(e)) {
			...
			if (explode) {
				...
				if (!res.canInteract(e.dimension, x - radius, y - radius, y + radius, z + radius, Permissions.Build) || !res.canInteract(e.dimension, x - radius, y - radius, y + radius, z + radius, Permissions.Build)
						|| !res.canInteract(e.dimension, x + radius, y - radius, y + radius, z - radius, Permissions.Build) || !res.canInteract(e.dimension, x + radius, y - radius, y + radius, z + radius, Permissions.Build)) {
					return "Target protected by MyTown";
				}
			}
